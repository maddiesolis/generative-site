...
export const AnswerCombos = [
    ...
    {result: [2, 1, 0], image: result_210, title: "Beautiful Mind", description: "Time warps as you zone out, and you enter a realm of imagination, where anything and everything is possible."},
